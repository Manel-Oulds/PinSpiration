          ...
          <div className="board-container">
            <div className="vertical-divs">
              {board.pins.length > 0 ? (
                <div className="div-vert1">
                  ...
                  <img className="div-img" src={pins[Object.values(boardPins[board.id])[0]]?.imgUrl} alt="pin1" />
                </div>
              ) : (
              ...
              {board.pins.length > 1 ? (
                <div className="div-vert2">
                  <img className="div-img" src={pins[Object.values(boardPins[board.id])[1]]?.imgUrl} alt="pin2" />
                </div>
              ) : (
            ...
            {board.pins.length > 2 ? (
                <div className="horizontal-div">
                  <img className="div-img" src={pins[Object.values(boardPins[board.id])[2]]?.imgUrl} alt="pin3" />
                </div>
              ) : (
